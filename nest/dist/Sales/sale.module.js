...
const Sale_schema_1 = require("../Schema/Sale.schema");
...
SaleModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: 'Sale', schema: Sale_schema_1.SaleSchema }])],
        providers: [sale_service_1.SaleService],
        controllers: [sale_controller_1.SaleController],
        exports: [mongoose_1.MongooseModule, sale_service_1.SaleService],
    })
], SaleModule);
